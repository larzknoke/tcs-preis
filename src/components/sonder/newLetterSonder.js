...
import Step1Sonder from "./steps/step1sonder";
import Step2Sonder from "./steps/step2sonder";
...
const fieldStepMap = {
  ...
  nachhaltigkeitProjekt: 1,
  uebertragbarkeitProjekt: 1,
  aufmerksamkeit: 1,
  eigenmittel: 2,
...
const fieldLabelMap = {
  ...
  nachhaltigkeitProjekt: "Nachhaltigkeit",
  uebertragbarkeitProjekt: "Übertragbarkeit",
  ...
  checkDatenschutzBilder: "Einverständnis Foto/Film/Ton",
...
function NewLetterSonder() {
  ...
  async function onSubmit(values) {
    ...
    try {
      ...
      console.error("ErrorNewLetterSonder:", error);
      setFormError(true);
      setErrorMsg(
...
export default NewLetterSonder;
