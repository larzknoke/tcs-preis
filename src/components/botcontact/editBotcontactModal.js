...
function EditBotcontactModal({ botcontact, isOpen, onClose }) {
  ...
  return (
    <>
      <Modal isOpen={isOpen} onClose={onClose} size={"xl"}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader>Ansprechpartner bearbeiten</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
            <form id="edit-botcontact-form" onSubmit={handleSubmit(onSubmit)}>
...
export default EditBotcontactModal;
